...
def LT_inclusion(scores_ind,alpha,df_t):   #df_t is the dataframe for test sequences (refer to preprocess.py)
...
def hit_mrr(scores_ind_new, Targets):
    hit,mrr=[],[]
    for score, target, mask in zip(scores_ind_new, Targets, test_data.mask):
